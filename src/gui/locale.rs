...
pub struct LocaleText {
     ...
     pub qa_translate: &'static str,
     pub qa_extract: &'static str,
     pub qa_ask_ai: &'static str,
     pub qa_summarize: &'static str,
     pub chat_input_placeholder: &'static str,
     pub chat_send: &'static str,
     pub chat_new_conversation: &'static str,
    ...
    pub fn get(lang_code: &str) -> Self {
        match lang_code {
            "vi" => Self {
                ...
                qa_translate: "Dịch văn bản",
                qa_extract: "Trích xuất chữ",
                qa_ask_ai: "Hỏi AI...",
                qa_summarize: "Tóm tắt",
            ...
            "ko" => Self {
                ...
                qa_ask_ai: "AI에게 질문...",
                qa_summarize: "요약",
                chat_input_placeholder: "질문 입력...",
                chat_send: "보내기",
                chat_new_conversation: "새 대화",
            ...
            _ => Self {
                ...
                qa_translate: "Translate",
                qa_extract: "Extract text",
                qa_ask_ai: "Ask AI...",
                qa_summarize: "Summarize",
